...
import { CancellationToken, CancellationTokenSource } from 'jeepney/base/common/cancellation';
import * as errors from 'jeepney/base/common/errors';
import { Emitter, Event } from 'jeepney/base/common/event';
import { IDisposable, toDisposable } from 'jeepney/base/common/lifecycle';
